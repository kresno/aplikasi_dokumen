...
<html lang="en">
  ...
  <body>
    <nav class="light-blue lighten-1" role="navigation">
      <div class="nav-wrapper container"><a id="logo-container" href="<?php echo base_url(); ?>" class="brand-logo">Simencrang</a></div>
    </nav>
      ...
      <div class="container login-box">
        <div class="card z-depth-5">
          <div class="card-content">
            ...
            <div class="row">
              <form class="col s12" id="login-form" method="post" action="<?php echo site_url('login/validasi'); ?>">
                <div class="row">
    ...
    <footer class="page-footer white">
      <div class="footer-copyright  blue darken-3">
        <div class="container center-align">
          Copyright &copy; <a class="white-text text-lighten-3" href="https://bappeda.sukabumikab.go.id">Bappeda Kab. Sukabumi</a>
        </div>
      </div>
    </footer>
