...
<html>
    <head>
        ...
        <meta name="description" content="Simencrang Sinkronisasi Dokumen">
        <meta name="author" content="Bappeda Kabupaten Sukabumi">
        ...
        <link href="<?php echo base_url('assets/admin/assets/plugins/datatables/responsive.bootstrap4.min.css'); ?>" rel="stylesheet" type="text/css" />
